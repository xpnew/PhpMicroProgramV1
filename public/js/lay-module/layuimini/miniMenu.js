...
layui.define(["element", "laytpl", "jquery"], function (exports) {
    ...
    var miniMenu = {
        ...
        render: function (options) {
            ...
            if (sessionStorage.getItem('leftMenuIsShow') === null) {
                options.leftMenuIsHide ? miniMenu.hideLeftMenu() : miniMenu.showLeftMenu()
            } else {
                sessionStorage.getItem('leftMenuIsShow') == 1 ? miniMenu.hideLeftMenu() : miniMenu.showLeftMenu()
            }
            miniMenu.listen();
        },
        ...
        listen: function () {
            ...
            $('body').on('click', '.layuimini-site-mobile', function () {
                ...
                sessionStorage.setItem('leftMenuIsShow', isShow)
                if (isShow == 1) {
                    miniMenu.hideLeftMenu()
                } else {
                    miniMenu.showLeftMenu()
                }
                element.init();
                layer.close(loading);
            });
