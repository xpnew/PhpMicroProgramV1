...
class BonusLog extends AdminBase
{
    /**
     * 显示资源列表
     *
   ...
   /**
    ...
    public function index()
    {
        ...
        $AssetModeDefs =  $statusdb -> where(['GroupId'=>9000,'IsShow'=>1]) -> order(['GroupOrd' ,'TypeId']) -> select();
        $this->assign('AssetModeDefs', $AssetModeDefs);
    ...
    public function query(){
        ...
        if($AssetModeId != ''){
            $where[] = ['AssetModeId','=',$AssetModeId];
        }       

        $db= new Client_BonusLogT();
