...
class WxPayApi
{
	...
	public static function unifiedOrder($inputObj, $timeOut = 6)
	{
		...
		$inputObj->SetSign();
		$xml = $inputObj->ToXml();
		\think\facade\Log::info("wxpay xml: ".$xml);
	...
	public static function notify($callback, &$msg)
	{
		...
		//https://blog.csdn.net/weng_xianhu/article/details/79419722

		//获取通知的数据
		// $xml = $GLOBALS['HTTP_RAW_POST_DATA'];
		$xml = isset($GLOBALS['HTTP_RAW_POST_DATA']) ? $GLOBALS['HTTP_RAW_POST_DATA'] : file_get_contents("php://input");
		\think\facade\Log::info("wxpay notify xml: ".$xml);		
		//如果返回成功则验证签名
		try {
	...
	{		
		...
		\think\facade\Log::info("wxpay response: ".$data);
